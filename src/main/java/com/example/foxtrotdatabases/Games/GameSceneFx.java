...
public class GameSceneFx {
    ...
    public VBox gameInput() {
        ...
        addButton.setOnAction(e ->addsGame(gameNameInput));
    ...
    public void addsGame(TextField gameNameInputTextField) {
        Games gamesToAdd = new Games(gameNameInputTextField.getText());
